  ...
  return (
    <div className="min-h-screen lg:flex page-fade-in">
      <aside className="lg:sticky lg:top-0 lg:h-screen w-full lg:w-80 bg-navy/95 backdrop-blur-xl text-white p-6 border-r border-white/10 shadow-2xl">
        ...
        <Link href="/clientes" className="btn-primary block text-center mb-6">
          + Nuevo cliente
        </Link>
      ...
      <div className="flex-1">
        <header className="sticky top-0 z-10 bg-white/70 backdrop-blur-xl border-b border-blue-100 px-6 py-4 flex items-center justify-between shadow-sm">
          <div>
            <p className="text-xs uppercase tracking-wide text-slate-500">NextUp CRM</p>
            <p className="font-semibold text-navy">Navegación integrada y accionable</p>
            <p className="text-[11px] text-slate-400">UI Rev: 2026-05-22-1</p>
          </div>
