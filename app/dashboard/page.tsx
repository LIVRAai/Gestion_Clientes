...
export default function Dashboard() {
  ...
  return <LayoutShell><div className="space-y-6">
    <section className="card card-hover p-6 bg-gradient-to-r from-blue-50 to-white">
      ...
      <p className="text-slate-600 mt-2">Comienza con acciones concretas: crea clientes, registra compras y activa campañas de recompra.</p>
    </section>
    ...
    <section className="grid md:grid-cols-3 gap-4"><div className="card p-5"><h2 className="font-semibold mb-3">Acciones rápidas</h2><div className="space-y-2"><a href="/clientes" className="btn-primary inline-block">Crear cliente</a><a href="/compras" className="btn-secondary inline-block ml-2">Registrar compra</a><a href="/recompra" className="btn-secondary inline-block ml-2">Ver recompra</a></div></div>
