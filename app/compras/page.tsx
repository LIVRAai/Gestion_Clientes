...
export default function ComprasPage(){
  ...
  return <LayoutShell><div className="space-y-4"><h1 className="text-3xl font-bold">Operación de compras</h1><p className="text-slate-600">Registra ventas para entender recompra, valor y comportamiento del cliente.</p>
