...
export default function ComprasPage(){
  ...
  async function save(e:React.FormEvent){
    ...
    setForm({...form,cliente_id:'',producto_id:'',cantidad:1,valor_unitario:0,notas:''});
    load();
  }
    ...
    <form onSubmit={save} className="card p-5 space-y-5">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div><label className="label">Valor total</label><input className="input bg-slate-50" value={valorTotal} readOnly/></div>
        </div>
      </div>
      <div>
