...
export default function ProductosPage(){
  ...
  return <LayoutShell><div className="space-y-4"><h1 className="text-3xl font-bold">Catálogo de productos</h1>
    <form onSubmit={save} className="card p-4 grid md:grid-cols-3 gap-3">
      ...
      <button className="btn-primary">{editId?'Guardar cambios':'Crear producto'}</button>
    </form>
